                        ...
                        <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
                            ...
                            <motion.div 
                                ...
                                <h6 className="mb-2 font-semibold">
                                    <span className="text-sm text-neutral-900 dark:text-purple-100">
                                        <a 
                                            href={publication.link} 
                                            target="_blank" 
                                            rel="noopener noreferrer"
                                            className="hover:text-neutral-700 dark:hover:text-purple-300 transition-colors"
                                        >
                                            {publication.title} <ArrowUpRightIcon className="inline w-4 h-4" />
                                        </a>
                                    </span>
                                </h6>
                                <p className="mb-4 text-neutral-800 dark:text-neutral-400">{publication.authors}<br/>
                                </p>
                            </motion.div>
                        </div>
                    ))}
